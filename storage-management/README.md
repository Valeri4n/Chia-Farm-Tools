...
`lsblk -o name,size,type,mountpoint|grep "disk.*16.4T "|grep -v -e /mnt -e ext4 -e xfs -e ntfs|awk '{print $1}'|while read drive; do ./format_drive.sh -u $USER -d $drive -n SomeName -t ext4; done`  
